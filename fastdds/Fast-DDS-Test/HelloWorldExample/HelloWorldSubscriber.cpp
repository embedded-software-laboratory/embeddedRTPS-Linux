...
bool HelloWorldSubscriber::init()
{
    ...
    IPLocator::setIPv4(mlocator, 239, 255, 0, 2); //Set this to Multicast address, which should be used!
    mlocator.port = 7401;

    eprosima::fastrtps::rtps::Locator_t ulocator;
    IPLocator::setIPv4(ulocator, 192, 168, 1, 1); //Set this to own IP address!
    ulocator.port = 7413;
